...
[
  '{{repeat(50)}}',
  {
    ...
    breed: function (tags) {
      var breeds = {
        dog:["labrador","pitbull","pug"],
        cat:["calico","ginger","tuxedo"],
...
[
  '{{repeat(250)}}',
  {
    ...
    lat: '{{floating(37.790657, 37.706761)}}',
    lng: '{{floating(-122.488079, -122.388321)}}',
    
    description: '{{lorem(3,"sentences")}}',
    
    photo: 'http://via.placeholder.com/400/',
    icon: 'http://via.placeholder.com/400/?text=ICON',
    date_create: '{{date(new Date(2020, 0, 1), new Date(), "YYYY-MM-dd hh:mm:ss")}}'
  }
]
